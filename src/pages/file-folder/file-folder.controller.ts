...
export class FileFolderController {
  ...
  @UseGuards(AdminPermissionGuard)
  @UseGuards(AdminJwtAuthGuard)
  async updateMultipleFileFolderById(@Body() updateFileFolderDto: UpdateFileFolderDto): Promise<ResponsePayload> {
  ...
  @UseGuards(AdminPermissionGuard)
  @UseGuards(AdminJwtAuthGuard)
  async deleteFileFolderById(@Param('id', MongoIdValidationPipe) id: string): Promise<ResponsePayload> {
  ...
  @UseGuards(AdminPermissionGuard)
  @UseGuards(AdminJwtAuthGuard)
  async deleteMultipleFileFolderById(@Body() data: { ids: string[] }): Promise<ResponsePayload> {
