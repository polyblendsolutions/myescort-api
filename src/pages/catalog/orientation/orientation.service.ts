...
export class OrientationService {
    ...
    constructor(
        @InjectModel('Orientation') private readonly orientationModel: Model<Orientation>,
    ...
    async updateMultipleOrientationById(
        ...
        try {
            await this.orientationModel.updateMany(
                {_id: {$in: mIds}},
                {$set: updateOrientationDto},
            );
